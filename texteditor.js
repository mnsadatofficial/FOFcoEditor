        ...
        <div class="fofco-wrapper">
            ...
            <div class="editor-container">
              ...
              <div class="toolbar">
                ...
                <button class="tool-btn fof-format-btn" data-cmd="outdent" title="Outdent (Shift+Tab)"><i class="fas fa-outdent"></i></button>
                <button class="tool-btn fof-format-btn" data-cmd="indent" title="Indent (Tab)"><i class="fas fa-indent"></i></button>
